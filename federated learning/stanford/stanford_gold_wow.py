...
print('train--')
print(df.iloc[:150000]['target'].value_counts())
print('val--')
print(df.iloc[150000:270000]['target'].value_counts())
print('test--')
print(df.iloc[270000:df.shape[0]]['target'].value_counts())
...
train_data=CustomImageDataset(df,'/DATA/chowdari1/DATA/dataset/stanford/',transformations["train"],0,150000)
valid_data=CustomImageDataset(df,'/DATA/chowdari1/DATA/dataset/stanford/',transformations["val"],150000,270000)
test_data=CustomImageDataset(df,'/DATA/chowdari1/DATA/dataset/stanford/',transformations["test"],270000,df.shape[0])
